 ...
 */
public class RibbonJGroupsArchiveImpl extends AssignableBase<ArchiveBase<?>> implements RibbonJGroupsArchive {
     ...
     * @param archive
     */
    public RibbonJGroupsArchiveImpl(ArchiveBase<?> archive) {
        super(archive);
    }
    ...
    @Override
    public RibbonJGroupsArchive setApplicationName(String serviceName) {
        return advertise(serviceName);
    }

    @Override
    public RibbonJGroupsArchive advertise() {
        doAdvertise();
        return this;
    }

    @Override
    public RibbonJGroupsArchive advertise(String... serviceNames) {
    ...
    protected RibbonJGroupsArchive doAdvertise() {
